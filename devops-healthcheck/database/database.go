...
func (s *Store)Save(service model.Service)error{
	query:=`INSERT INTO services (user_id,name,url,healthy,statusCode,checked_at) VALUES($1,$2,$3,$4,$5,$6)`
	_,err:=s.DB.Exec(query,service.UserID,service.Name,service.URL,service.Healthy,service.StatusCode,service.Checked_at)
	if err != nil{
		return err
	}
	return nil
